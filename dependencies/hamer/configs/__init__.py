...
CACHE_DIR_HAMER = "./pretrained_models/hamer_ckpts"
ABS_DIR_HAMER = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    ...
    if update_cachedir:
      def update_path(path: str) -> str:
        if os.path.isabs(path):
          return path
        return os.path.join(ABS_DIR_HAMER, cfg.MANO.DATA_DIR, path)
