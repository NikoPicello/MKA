...
class SMPLify(object):
        ...
        for iter_idx in range(n_iter):
            for optimizer_key, optimizer in optimizers.items():
                ...
                def closure():
                    ...
                    # print(optimizer_key, loss)
                    total_loss = loss_dict['total_loss']
                    if isinstance(total_loss, torch.Tensor) and not torch.isnan(total_loss):
                    ...
                    for key, value in optim_param.items():
                        if value.grad is not None:
                            ...
                            # print('grad:', torch.isnan(value.grad).any())
            ...
            if iter_idx > 0 and pre_loss is not None and ftol > 0 and total_loss > 0.:
    ...
    def __compute_loss__(self,
        ...
        for handler in self.loss_handlers:
            ...
            # print("=== handle_key", handler_key, flush=True)
