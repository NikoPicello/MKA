...
_GlobalPosePriorLoss = TypeVar('_GlobalPosePriorLoss')


class GlobalPosePriorHandler(BaseHandler):

    def __init__(self,
                 prior_loss: Union[_GlobalPosePriorLoss, dict],
                 handler_key='global_pose_prior',
