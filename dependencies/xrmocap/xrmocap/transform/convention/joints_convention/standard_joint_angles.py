...
STANDARD_JOINT_ANGLE_LIMITS_LOCK_FOOT = torch.deg2rad(
    torch.Tensor([
        ...
        [[-5, 5], [-1, 1], [-1, 1]],  # 09, 'left_foot',
        [[-5, 5], [-1, 1], [-1, 1]],  # 10, 'right_foot',
    ]))
...
#         [[-15, 15], [-3, 3], [-3, 3]],  # 11, 'neck',
#     ]))

STANDARD_JOINT_ANGLE_LIMITS_LOCK_APOSE_SPINE = torch.deg2rad(
    torch.Tensor([
        [[-3, 3], [-3, 3], [-15, 15]],  # 02, 'spine1',
        [[-3, 3], [-3, 3], [-15, 15]],  # 05, 'spine2',
        [[-3, 3], [-3, 3], [-15, 15]],  # 08, 'spine3',
        [[-15, 15], [-15, 15], [-30, 30]],  # 11, 'neck',
    ]))
