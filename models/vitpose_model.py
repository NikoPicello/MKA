...
ROOT_DIR = "./"
VIT_DIR = os.path.join(ROOT_DIR, "dependencies/ViTPose")
...
class ViTPoseModel(object):
    MODEL_DICT = {
        'ViTPose+-G (multi-task train, COCO)': {
            ...
            'model': f'{ROOT_DIR}/pretrained_models/vitpose_ckpts/vitpose+_huge/wholebody.pth',
        },
    }
    ...
    def predict_pose(
        ...
        out, res = inference_top_down_pose_model(self.model,
                                               image,
